...
class Display():
    def __init__(self,position='middle'):
        ...
        img_path = self.current_path + '/AImaid/resource/img/Animation'
        ...
        for i in range(0,108):
            framex = pygame.image.load(img_path+'/NORMAL/NORMAL_'+str(i).zfill(6)+'.png')
            normal_frames.append(framex)
        
        for i in range(0,93):
            framey = pygame.image.load(img_path+'/TALK/TALK_'+str(i).zfill(6)+'.png')
    ...
    def playAction(self):
        ...
        infoframe = pygame.image.load(self.current_path+'/AImaid/resource/img/info.jpg')
        backframe = pygame.image.load(self.current_path+'/AImaid/resource/img/back.png')
